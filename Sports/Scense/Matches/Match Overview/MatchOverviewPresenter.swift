...
extension MatchOverviewPresenter: MatchOverviewPresenterProtocol {
    ...
    func numberOfRowsInSections(in section: MatchOverviewSection) -> Int {
        switch section {
        case .venue: return match.details?.venueDetails != nil ? 1 : 0
        case .weather: return match.details?.matchDetails?.weather != nil ? 1 : 0
        case .tournament: return match.details?.tournamentDetails != nil ? 1 : 0
        }
    }
