...
final class MatchesPresenter: NSObject {
    // MARK: - Properties
    ...
    // MARK: - Init
    init(view: MatchesControllerProtocol?,
         interactor: MatchesPresenterInteractorProtocol?,
...
extension MatchesPresenter: MatchesInteractorOutput {
