...
class MatchesInteractor {
    ...
    var presenter: MatchesInteractorOutput?
...
extension MatchesInteractor: MatchesPresenterInteractorProtocol {
    ...
    func fetchMatches(parameters: MatchesRequest) {
        ...
        let tournament: AnyPublisher<MatchesEntity, Error> = session.requestQuery(from: url, withQueryParams: parameters)
